...
function help(){
	...
	// Z170-DELUXE
	// </h3></div>
	// <script src="http://cdefgab.web.fc2.com/qv3.js" type="text/javascript" charset="utf-8" async defer></script>
	// <input class ="key_word"  a_url="http://www.asus.com/jp/Motherboards/Z170-DELUXE/" value="Z170-DELUXE" style="display:none">
	// <input class ="key_word"  a_url="" value="X99-E WS" style="display:none">
	// <input class ="key_word"  value="MAXIMUS VIII GENE" style="display:none">
...
function start(){
	...
	for(var i=0; i < get.length; i++){
		...
		if(!document.getElementById(get[i].value)) {
			...
			xxxjson(lulu2.call(new link(get[i].value)), get[i].value, a_url);
		}
	}
 }
