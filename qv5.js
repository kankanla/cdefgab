...
function start(){
	...
	for(var i=0; i < get.length; i++){
		...
		if(!document.getElementById(get[i].value)) {
			...
			xxxjson(lulu2.call(new link(fn_replace(get[i].value), c_max)), get[i].value, a_url);
		}
	}
 }
